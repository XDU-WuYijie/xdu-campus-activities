...
CREATE TABLE IF NOT EXISTS `tb_activity_registration` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '报名状态：1已报名',
...
INSERT INTO `tb_activity` (`creator_id`, `organizer_name`, `title`, `cover_image`, `summary`, `content`, `category`, `location`, `max_participants`, `registered_count`, `registration_start_time`, `registration_end_time`, `event_start_time`, `event_end_time`, `check_in_enabled`, `status`)
...
INSERT INTO `tb_activity` (`creator_id`, `organizer_name`, `title`, `cover_image`, `summary`, `content`, `category`, `location`, `max_participants`, `registered_count`, `registration_start_time`, `registration_end_time`, `event_start_time`, `event_end_time`, `check_in_enabled`, `status`)
SELECT 1, '就业与实践服务站', '大型招聘会志愿者招募', 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1200&q=80', '面向校园大型招聘会招募现场志愿者，支持报名与现场签到。', '志愿者将协助签到引导、秩序维护和咨询答疑，适合希望参与大型活动组织的同学报名。', '志愿服务', '南校区体育馆', 80, 0, '2026-04-20 08:00:00', '2026-04-25 20:00:00', '2026-04-30 08:30:00', '2026-04-30 18:00:00', 1, 2
